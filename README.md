...
Realistically, adding Custom Team support - [Alliances](https://www.pivotaltracker.com/epic/show/3725677), and [Fireteams](https://www.pivotaltracker.com/epic/show/3790817).  If you poke around the pipeline database schema, you'll see the "Team Sources" table, which allows teams from different sources to exist.  However, I need to provide a way for users to create and manage those teams on the front end before this'll be useful.
